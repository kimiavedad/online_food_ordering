# Generated by Django 4.0 on 2021-12-31 13:03
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ادمین سایت', 'ادمین سایت'), ('مدیر رستوران', 'مدیر رستوران'), ('مشتری', 'مشتری')], default='مشتری', max_length=20)),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.AddField(
            ...
            name='addresses',
            field=models.ManyToManyField(blank=True, through='accounts.UserAddress', to='accounts.Address'),
        ),
        migrations.AddField(
            model_name='customuser',
            name='groups',
